...
<!-- <div class="leftContainer">
      ...
      <div class="footer-text">KhelAkhada is a real-money gaming product owned
         ("KhelAkhada" or "We" or "Us" or "Our").</div><br>
      ...
      <div class="footer-text">KhelAkhada is a skill-based real-money gaming platform accessible only for our users in
         India. It is accessible on <a target="_blank" rel="noopener noreferrer"
            href="https://khelakhada.com/">https://khelakhada.com/</a>. On khelakhada, users can compete for real cash in
      ...
      <div class="footer-text">KhelAkhada has a wide-variety of high-quality, premium HTML5 games. Our games are especially
      ...
      <div class="footer-text">We have games across several popular categories: Arcade, Action, Adventure, Sports &amp;
         ...
         to drop in a line at <a href="#">support@khelakhada.com</a>!</div>
   </div>
         </section>
